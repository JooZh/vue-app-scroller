    ...
    <div class="datetime" v-if="open">
      ...
      <div class="datetime-inner">
        <div class="datetime-title border-bottom-1px">
          <button class="datetime-title-btn cancel" v-text="buttons[0].text" @click="buttonClick(buttons[0])"></button>
          <span class="datetime-title-name" v-text="title"></span>
          <button class="datetime-title-btn confrim" v-text="buttons[1].text" @click="buttonClick(buttons[1])"></button>
        </div>
